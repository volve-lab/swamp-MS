                                            ...
                                            <tr>
                                                ...
                                                @if($contract->status=='Pending')
                                                    <div class="btn-group">
                                                        ...
                                                        <a class="dropdown-item" href="{{route('status.contract.approve',['id'=>$contract->id])}}">Approve</a>
                                                       
                                                          <a class="dropdown-item" href="{{route('status.contract.deny',['id'=>$contract->id])}}">Deny</a>
