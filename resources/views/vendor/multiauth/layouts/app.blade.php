    ...
    <header class="header navbar fixed-top navbar-expand-sm">
        ...
        <ul class="navbar-nav flex-row ml-lg-auto">
            ...
            <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="flaticon-user-12">{{ auth('admin')->user()->name }}</span>
                </a>
                <div class="dropdown-menu  position-absolute" aria-labelledby="userProfileDropdown">
                    <a class="dropdown-item" href="{{ route('admin.password.change') }}">
                        <i class="mr-1 flaticon-user-6"></i> <span>Change Password</span>
                    </a>
            ...
            <nav id="sidebar">
                ...
                <ul class="navbar-nav theme-brand flex-row  d-none d-lg-flex">
                    ...
                    <li class="nav-item theme-text">
                        <a href="{{route('admin.home')}}" class="nav-link"> SWAMP MS </a>
                    </li>
                </ul>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <li>
                            ...
                            <li>
                                <a href="{{ route('admin.show') }}"> User </a>
                            </li>

                            <li>
                                <a href="{{ route('cooperative.users') }}"> Cooperative </a>
                            </li>
                    ...
                    <li class="menu">
                                            <a href="#cooperative_management" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                                <div class="">
                                                    <i class=""></i>
                                            ...
                                            <ul class="collapse submenu list-unstyled" id="cooperative_management" data-parent="#accordionExample">
                

                                                <li>
                                                        <a href="{{ route('cooperative.management') }}"> View </a>
                    ...
                    @admin('district')
                                        ...
                                        <li class="menu">
                                            <a href="#swamp" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                                <div class="">
                                                    <i class=""></i>
                                                    <span>Swamp</span>
                                                </div>
                                            ...
                                            <ul class="collapse submenu list-unstyled" id="swamp" data-parent="#accordionExample">
                                            <li>
                                                        <a href="{{ route('swamp.create') }}"> Register </a>

                                                </li>

                                                <li>
                                                        <a href="{{ route('swamp.index') }}"> Swamps </a>
                                        ...
                                        <li class="menu">
                                            ...
                                            <li>
                                                        <a href="{{ route('swamp.district.request') }}"> Requests </a>

                                                </li>

                                                <li>
                                                        <a href="{{ route('swamp.district.payment') }}"> Payment </a>
...
<li class="menu">
    <a href="#rema_swamp" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
        <div class="">
            <i class=""></i>
            <span>Swamp</span>
        </div>
    ...
    <ul class="collapse submenu list-unstyled" id="rema_swamp" data-parent="#accordionExample">
   

        <li>
                <a href="{{ route('swamp.rema') }}"> Swamps </a>

        </li>

        <li>
                <a href="{{ route('swamp.rema.used') }}"> Used swamp </a>
